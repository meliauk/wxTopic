...
export default function (settings, filename, text, callback) {
    ...
    // speechConfig.speechSynthesisOutputFormat = sdk.SpeechSynthesisOutputFormat.AmrWb16000Hz;
